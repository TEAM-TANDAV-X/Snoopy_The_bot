...
@bot.on(admin_cmd(pattern=f"gaali$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"gaali$", allow_sudo=True))
async def thenus(e):
...
@bot.on(admin_cmd(pattern=f"3gali$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"3gali$", allow_sudo=True))
async def chut(e):
...
@bot.on(admin_cmd(pattern=f"gay$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"gay$", allow_sudo=True))
async def metoo(e):
    txt = random.choice(GEY_STRINGS)
    await edit_or_reply(e, txt)


@bot.on(admin_cmd(pattern=f"pro$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"pro$", allow_sudo=True))
async def metoo(e):
...
CmdHelp("fun").add_command(
  ...
  'pro', None, 'Sends some random lines for "piro" guys'
).add_command(
  'gay', None, 'Sends some random lines for geys (°^°)'
).add_command(
  ...
  '3abuse', None, 'Some of the abusive shayris'
).add_command(
  'fuk', None, 'Use and see bruh'
).add_command(
  '2abuse', None, 'Use and see'
).add_command(
