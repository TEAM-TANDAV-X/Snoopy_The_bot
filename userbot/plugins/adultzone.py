...
async def boobs(event):
    ...
    a = await event.reply("Hn Ruk Tharki Tere Liye Boobs Dhoodh Rha Hu🧐")
    await asyncio.sleep(0.5)
    await a.edit("HN RUKJA THARKI DE RHA HU🤪")
...
async def butts(event):
    ...
    a = await event.reply("HN THARKI DETA HU TUJHE BUTTS KU PIC🧐")
    await asyncio.sleep(0.5)
    await a.edit("HN RUKJA THARKI BUTTS KI PIC DERA HU🤪")
